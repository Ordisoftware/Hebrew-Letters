  ...
  static partial class AppTranslations
  {
    ...
    static public readonly NullSafeDictionary<string, TranslationsDictionary> NoticeNewFeatures
      = new NullSafeDictionary<string, TranslationsDictionary>
      {
        ...
        {
          [Language.EN] = "Startup speed and analysis combo boxes creation are optimized." + Globals.NL2 +
                          "Data edition is improved to have save and cancel behavior." + Globals.NL2 +
          ...
          [Language.FR] = "Le temps de démarrage et la création des boites combos d'analyse sont optimisé." + Globals.NL2 +
                          "L'édition des données est améliorée pour avoir le comportement sauver et annuler." + Globals.NL2 +
