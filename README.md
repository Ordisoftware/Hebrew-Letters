...
- Fix pasting unicode chars does not decode special final letters.
- Fix changing language not done on preference panel until next launch when analysis panel is current.
- Fix UI colors.
